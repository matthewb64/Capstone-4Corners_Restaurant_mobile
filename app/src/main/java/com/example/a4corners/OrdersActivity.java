...
public class OrdersActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.fragment_container) != null) {
            if (savedInstanceState == null) {
                ...
                fragmentTransaction.add(R.id.fragment_container, new OrdersFragment(), "");
